...
The latest released version of :obj:`differences` can be installed from `PyPI <https://pypi.org/project/differences/>`_ using `pip`.

.. code-block:: console

   $ python3 -m pip install differences
...
.. code-block:: console
   ...
   $ python3 -m pip install git+https://github.com/bernardodionisi/differences.git

Or from a specific branch.

.. code-block:: console

   $ python3 -m pip install git+https://github.com/bernardodionisi/differences.git@branch
...
fashion from a local folder. This allows any changes in the current directory to be immediately seen upon the next `import differences`.
...
.. code-block:: console
    ...
    $ python3 -m pip install -e differences/
...
.. code-block:: console
   ...
   $ python3 -m pip install differences[dev]
